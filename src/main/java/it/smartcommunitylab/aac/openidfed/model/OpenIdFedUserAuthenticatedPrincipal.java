...
public class OpenIdFedUserAuthenticatedPrincipal extends AbstractUserAuthenticatedPrincipal {
    ...
    public OpenIdFedUserAuthenticatedPrincipal(
        String provider,
        String realm,
        String userId,
        String subject
    ) {
        super(SystemKeys.AUTHORITY_OPENIDFED, provider, realm, subject, userId);
