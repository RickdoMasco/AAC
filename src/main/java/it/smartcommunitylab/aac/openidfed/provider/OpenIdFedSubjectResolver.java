...
@Transactional
public class OpenIdFedSubjectResolver extends AbstractProvider<OIDCUserAccount> implements SubjectResolver<OIDCUserAccount> {
    ...
    public OpenIdFedSubjectResolver(
        String providerId,
