...
public class OpenIdFedAccountPrincipalConverter
    ...
    public OpenIdFedAccountPrincipalConverter(
        String providerId,
        OpenIdFedIdentityProviderConfig config,
        String realm
    ) {
        super(SystemKeys.AUTHORITY_OPENIDFED, providerId, realm);
    ...
    public OIDCUserAccount convertAccount(UserAuthenticatedPrincipal userPrincipal, String userId) {
        ...
        Assert.isInstanceOf(
            OpenIdFedUserAuthenticatedPrincipal.class,
            userPrincipal,
            "principal must be an instance of oidc authenticated principal"
        );
        OpenIdFedUserAuthenticatedPrincipal principal = (OpenIdFedUserAuthenticatedPrincipal) userPrincipal;
