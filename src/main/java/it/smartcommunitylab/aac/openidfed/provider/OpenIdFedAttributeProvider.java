...
public class OpenIdFedAttributeProvider
    extends AbstractIdentityAttributeProvider<OpenIdFedUserAuthenticatedPrincipal, OIDCUserAccount> {

    private final OpenIdAttributesMapper openidMapper;

    public OpenIdFedAttributeProvider(String providerId, OpenIdFedIdentityProviderConfig providerConfig, String realm) {
